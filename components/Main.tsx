...
export default function Main() {
    return (
        <section id='home' className='bgMain'>
            <div className='maxW'>
                ...
                <article className='z-10 relative flex gap-y-4 flex-col justify-center h-[100vh] lg:w-[50%]'>
                    <div className='flex justify-center gap-2 lg:justify-start'>
                        ...
                        <h5 className='font-GochiHand text-BlackH1 text-xl'>Assinaturas fresquinhas em Brotas</h5>
                    </div>

                    <h2 className='text-BlackMain font-Manrope font-extrabold text-4xl text-center lg:text-6xl lg:text-left'>O sabor do campo na sua mesa.</h2>
                    <p className='text-center lg:text-left'>
                        Escolha o plano ideal da Hortaliças Santa Cruz e receba sua cesta de hortaliças todos os meses, com praticidade, variedade e produtos selecionados direto de Brotas.
                    </p>
                    <div className='mt-2 flex flex-col gap-3 sm:flex-row sm:justify-center lg:justify-start'>
                        <a className='bg-YellowP px-6 py-3 rounded-2xl font-Manrope text-center' href="#assinaturas">Quero escolher meu plano</a>
                        <a className='border border-BlackMain px-6 py-3 rounded-2xl font-Manrope text-center text-BlackMain' href="#contact">Falar com a equipe</a>
                    </div>
                </article>
            </div>
        </section>
